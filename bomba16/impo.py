...
def leer_datos_hoja_individual(nombre_archivo, nombre_hoja, planta):
    ...
    Devuelve una lista de datos (sin filtrar por año).
    """
...
if __name__ == "__main__":
    ...
    print("📅 Leyendo TODOS los datos de ambos archivos (procesando hoja por hoja, fila 4)...")

    # Leer datos de cada hoja en ambos archivos
    datos_totales = []
    ...
    for nombre_hoja in hojas_colectiva:
        ...
        datos_hoja = leer_datos_hoja_individual(archivo_excel_colectiva, nombre_hoja, 'colectiva')
    ...
    for nombre_hoja in hojas_selectiva:
        # Intentar leer la hoja como una hoja de datos
        datos_hoja = leer_datos_hoja_individual(archivo_excel_selectiva, nombre_hoja, 'selectiva')
        datos_totales.extend(datos_hoja)


    print(f"📥 Preparados {len(datos_totales)} registros para subir...")
