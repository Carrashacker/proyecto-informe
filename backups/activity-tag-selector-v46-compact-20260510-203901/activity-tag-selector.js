(function() {
  ...
  function ensureModal() {
    ...
    modal.innerHTML = '<div class="ats-backdrop" data-ats-close="1"></div><section class="ats-card" role="dialog" aria-modal="true"><header class="ats-head"><div><p>Menu de equipos</p><h2>Seleccione TAG</h2></div><button type="button" class="ats-close" data-ats-close="1">Cerrar</button></header><div class="ats-tools"><input id="activityTagSelectorSearch" type="search" placeholder="Buscar TAG o equipo en todo el menu..." autocomplete="off"><span id="activityTagSelectorPicked" class="ats-picked">Seleccione un elemento del menu</span></div><div class="ats-nav"><button id="activityTagBack" class="ats-back" type="button">Volver</button><nav id="activityTagBreadcrumbs" class="ats-crumbs"></nav></div><div id="activityTagSelectorTree" class="ats-tree"></div></section>';
